    ...
    <div className="App">
      ...
      <div class="flex flex-col">
        <div class="flex flex-col md:flex-row">
          <div class="w-full md:w-1/2 pr-2 text-white">
            <CssTextField
              fullWidth
              margin="normal"
              type="text"
            ...
            />
            <div class="mt-6">
              <p class="inline-flex text-xs font-thin text-gray-500 mb-2 sm:text-sm dark:text-gray-100 hover:text-gray-700 dark:hover:text-white">
                {" "}
                Upload image banner
              </p>
